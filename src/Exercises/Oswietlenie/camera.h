...
public:
    void look_at(const glm::vec3 &eye, const glm::vec3 &center, const glm::vec3 &up) {
        z_ = glm::normalize(eye-center);//Ruch kamery
        x_ = glm::normalize(glm::cross(up,z_));//Ruch kamery
        y_ = glm::normalize(glm::cross(z_,x_));//Ruch kamery
        position_=eye;//Ruch kamery
        center_=center;//Ruch kamery
    }
