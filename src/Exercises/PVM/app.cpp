...
void SimpleShapeApplication::init() {
    ...
    std::vector<GLfloat> vertices = {
            ...
            0.5f, -0.5f,  0.0, 1.0, 0.0, 0.0,
            -0.5f,  0.5f,  0.0, 1.0, 0.2, 0.0,
            0.5f,  0.5f,  0.0, 1.0, 0.0, 0.5,
            0.0f, 1.0f, 0.0, 0.0, 1.0, 0.0,
    };//Współrzędne poza zakresem <-1,1> powodują "narysowanie" wieszchołka poza ekranem
    //Z odpowiada za "odległość" danego wierzchołka
    ...
    std::vector<GLushort> indices={0,1,2,1,3,2,2,4,3};
    ...
    ///PVM CD
    auto V =glm::lookAt(glm::vec3{0.0, -.5, 2.0},
